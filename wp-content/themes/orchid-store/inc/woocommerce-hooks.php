    ...
    function orchid_store_wishlist_icon_action() {
        ...
        if( class_exists( 'YITH_WCWL' ) ) {
            ...
            <div class="wishlist-icon-container" style="position:relative;">
                <a href="<?php echo esc_url( home_url() . '/wishlist' ); ?>"><span id="count_wishlist_sang1" class="cart_contents_count_wishlist_sang1"><?php echo YITH_WCWL()->count_products();?></span><i class='bx bx-heart'></i></a>
	...
	function orchid_store_mini_cart_action() {
		...
		<div class="mini-cart">
            <button class="trigger-mini-cart">
                ...
                <div id="cart_sang1">
                    <?php	
                        echo "<span class='cart_contents_count_custom_sang1'>";
